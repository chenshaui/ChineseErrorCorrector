...
<p align="center">
  <img src="https://img.shields.io/badge/ACL_2026-Main_(ChineseErrorCorrector4--4B,_即将开放)-red" alt="ACL 2026 Main">
...
🏆 荣获 **2026 ACL Main**（ChineseErrorCorrector4-4B，即将开放）🎉 · [2024 CCL 冠军](https://aclanthology.org/2024.ccl-3.31/) · [2023 NLPCC-NaCGEC 纠错冠军](#nacgec-数据集-) · [2022 FCGEC 纠错冠军](#fcgec-数据集-)，如有帮助，感谢 Star ✨。

> 🔭 **当前可用 SOTA**：[ChineseErrorCorrector3-4B](https://huggingface.co/twnlp/ChineseErrorCorrector3-4B)（2025 年发布，[arXiv:2511.17562](https://arxiv.org/abs/2511.17562)）。
> 🚧 **下一代**：**ChineseErrorCorrector4-4B**（**ACL 2026 Main**）模型、数据集与论文整理中，**尚未开放**，敬请期待。
...
[2026/04/07] 🎉🎉🎉 **ChineseErrorCorrector4-4B** 荣获 **2026 ACL Main** ！不久后将正式发布 ChineseErrorCorrector4-4B 模型、数据集及论文，**目前尚未开放**，敬请期待！🚀
...
| 模型名称                                                                                        | 纠错类型  | 状态 | 描述                                         |
|:--------------------------------------------------------------------------------------------|:------|:--|:-------------------------------------------|
| **ChineseErrorCorrector4-4B**                                                               | 语法+拼写 | 🚧 **ACL 2026 Main 论文模型，整理中，尚未开放** | 下一代旗舰模型，更稳、更快、更准；正式发布前请使用下方 3-4B。 |
| [twnlp/ChineseErrorCorrector3-4B](https://huggingface.co/twnlp/ChineseErrorCorrector3-4B)   | 语法+拼写 | ✅ 已开源（当前 SOTA，推荐） | 使用200万纠错数据进行全量训练，适用于语法纠错和拼写纠错，效果最好，推荐使用。   |
...
If this work is helpful, please kindly cite as（**ChineseErrorCorrector3-4B 论文**；**ChineseErrorCorrector4-4B / ACL 2026 Main** 论文整理中，发布后再更新引用）：
